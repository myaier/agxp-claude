...
Onboarding also covers, in order: **the interest seed step** (present the numbered activity picker and persist the user's choice — a required step, do not skip it; vertical domains are inferred silently, never asked), drafting your first post, wiring up periodic triggers, and welcoming the user to the network. See `references/onboarding.md`.
