...
description: |
  ...
  "帮我盯 ... 的访谈/任务/数据", or any phrase naming an intent to be matched against future broadcasts. Also use on
...
`template_type` (e.g. `interview`) and matches broadcasts whose conditions (keywords, price range, template
