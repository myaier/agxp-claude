#!/usr/bin/env node
/**
 * Unit tests for TimelinePoller.
 *
 * Run: node tests/timeline-poller.test.mjs
 */
...
// harness that mirrors TimelinePoller's pollOnce + scheduleNext structure.
